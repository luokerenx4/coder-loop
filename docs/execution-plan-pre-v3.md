...
> 更新于 2026-06-12（第 5 版：W0/W0.5 已完成；新 issue #448/#449 入波）。本文件的读者是**调度者**——负责按下方波次表启动任务区块、观察完成、推进下一波的 agent。波次表是操作员已裁决的执行顺序，**不是建议**：不得提前、不得重排、不得合并或拆分轨道。遇到本文件未覆盖的情况，停下报告操作员，不要自行变通。
...
|---|---|---|
| W0 ✅ | (#424→#426) ∥ (#421→#435) ∥ #422 | 已完成（PR #440/#447、#442/#446、#443） |
| W0.5 ✅ | #425 ∥ #427 | 已完成（PR #441、#439） |
| W1 | #411 ∥ (#428→#449) ∥ #429 | **当前波次，立即可开**，3 条轨道；#429 完成是 W2 闸门 |
| W2 | (#412→#433) ∥ (#398→#401→#402) ∥ (#399→#448) ∥ #400 ∥ #434 | 5 条轨道，需 5 份 clone |
...
```mermaid
flowchart LR
  W0["W0 + W0.5 ✅"] --> W1["W1（当前）<br/>3 条轨道"] --> W2["W2<br/>5 条轨道"] --> W3["W3<br/>4 条轨道"] --> W4["W4<br/>4 条轨道"] --> W5["W5<br/>#407"] --> W6["W6<br/>#409→#410"] --> W7["W7<br/>#419"]
```

## 已完成（无需再调度）

- 波次表之前关闭：#417（PR #423）、#430（PR #431）、#414（PR #415）。
- W0：#424（PR #440）、#426（PR #447）、#421（PR #442）、#435（PR #446）、#422（PR #443）。
- W0.5：#425（PR #441）、#427（PR #439）。
- 波次表之外由操作员直接推动：#437（PR #438）、PR #445（review retry 修复）。这类轨道外工作不需要调度者跟进。
